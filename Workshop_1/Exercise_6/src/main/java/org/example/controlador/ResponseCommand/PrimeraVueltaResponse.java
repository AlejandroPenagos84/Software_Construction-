...
public class PrimeraVueltaResponse implements ResponseCommand<ResultadoEleccionDTO>{
    private final CandidatoService candidatoService;

    public PrimeraVueltaResponse(CandidatoService candidatoService) {
    ...
    public CommandResult<ResultadoEleccionDTO> execute(Map<String, String> datos) {
        ...
        ResultadoEleccionDTO resultadoEleccionDTO = this.candidatoService.calcularPrimeraVuelta(candidatoDTOList);
